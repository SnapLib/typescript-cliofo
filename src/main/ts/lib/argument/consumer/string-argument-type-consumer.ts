...
export class StringArgumentTypeConsumer<ConvertedStringType> extends StringArgumentStringConsumer
{
    ...
    public constructor( stringValue: string,
                        ...
                        convertedStringPredicate: (convertedString: ConvertedStringType) => boolean = StringArgumentTypeConsumer.#defaultConvertedStringPredicate )
    {
    ...
    public hasConvertedStringPredicate(): boolean
        { return this.#convertedStringPredicate !== StringArgumentTypeConsumer.#defaultConvertedStringPredicate; }
    ...
    protected static defaultConvertedStringPredicate(): () => boolean
        { return StringArgumentTypeConsumer.#defaultConvertedStringPredicate; }
}

export {StringArgumentTypeConsumer as default};
